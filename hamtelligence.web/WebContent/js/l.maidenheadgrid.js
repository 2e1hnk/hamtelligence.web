...
L.Graticule = L.GeoJSON.extend({
    ...
    _getGraticule: function () {
        var features = [];
        var horizontal_interval = this.options.horizontal_interval;
        var vertical_interval = this.options.vertical_interval;

        // Meridians
        for (var lng = 0; lng <= 180; lng = lng + horizontal_interval) {
        ...
        // Parallels
        for (var lat = 0; lat <= 90; lat = lat + vertical_interval) {
...
L.maidenhead_grid = function (options) {
